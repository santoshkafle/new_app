          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: context.watch<FormProvider>().userNameCorrection,
              ...
              TextFormField(
                ...
                autovalidateMode: AutovalidateMode.onUserInteraction,
                validator: context.watch<FormProvider>().phNumberCorrection,
                decoration: InputDecoration(
                  label: Text("Phone Number to Verify that You are a Human"),
                  border: OutlineInputBorder(),
                ),
              ),
                  ...
                  if (_regFormKey.currentState?.validate() ?? false) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        ...
                        content: Text('Failled to create account'),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('Login Here', style: TextStyle(fontSize: 13)),
                  ),
                ],
              ),
            ],
